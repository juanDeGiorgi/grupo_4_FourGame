CREATE DATABASE  IF NOT EXISTS `fourgametest` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `fourgametest`;
...
INSERT INTO `address` VALUES (1,'César Garat ','1095',1722,'Merlo','la casa esta en una esquina ,rejas de color negro no tiene tiembre','Buenos Aires',1),(2,'calle falsa','1234',1232,'la plata','frente blanco ,no anda el timbre','Santiago del Estero',4);
...
CREATE TABLE `orders` (
  ...
  CONSTRAINT `FK_d8dc20de-f195-4d7f-898b-200bf10cf065` FOREIGN KEY (`payMethodId`) REFERENCES `paymethods` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `users` VALUES (1,'juan','juanmadegiorgi@gmail.com','img-1634262917437.jpg','$2a$12$wL2ZSsc19lTwGCqZiUC4GedUcwQILqXtakNLsEdiVefjho7MKMMNu','2021-09-22 02:16:18','2021-10-15 04:22:48',NULL,'2021-10-15 04:22:48',0,2),(3,'eze','eze@gmail.com','default-user-image.png','$2a$12$ezh87h3Vj.Gd/5j8l7QmSOa6yBMlX8Phuo8FFDNxwQMPW5.4EgsJC','2021-10-15 02:31:08','2021-10-15 02:31:08',NULL,'2021-10-15 02:31:08',0,1),(4,'pepe','pepe@gmail.com','default-user-image.png','$2a$12$aNt1788wwutYVjXa1HvAse06fRAul1yof96ocNX4m/xik1Ivrvfmu','2021-10-15 03:42:09','2021-10-15 03:47:13',NULL,'2021-10-15 03:47:13',0,1);
...
-- Dump completed on 2021-10-15  1:35:49
